...
public class VehiculeController {
	...
	public VehiculeModel editVehicule(@RequestBody VehiculeModel vehicule,@PathVariable Long id) {
		...
		vehiculeToUpdate.setListPersonne(vehicule.getListPersonne());
		vehiculeToUpdate.setListAffaire(vehicule.getListAffaire());
